...
class Knowledge_Hooks {
	...
	public static function handle_save_post( int $post_id, $post ): void {
		...
		$collections = Knowledge_Database::list_collections( 'active' );
	...
	public static function handle_delete_post( int $post_id ): void {
		...
		$sources_table = Knowledge_Database::sources_table();
		...
		foreach ( $sources as $source ) {
			Knowledge_Database::delete_source( (int) $source->id );
		}
	}
