...
class AgentLoop {
	 ...
	 *
	 * Delegates to OpenAIProxy which handles request formatting, the HTTP call,
	 * response parsing, and error handling.
	 *
	 * @return SimpleAiResult|WP_Error
	 */
	private function send_prompt_direct() {
		$endpoint_url = (string) get_option( 'openai_compat_endpoint_url', '' );
